...
pub use storage::{
    StorageHostFunctions, HOST_STORAGE_ALLOC, HOST_STORAGE_DELETE, HOST_STORAGE_GET,
    HOST_STORAGE_GET_RESULT, HOST_STORAGE_NAMESPACE, HOST_STORAGE_PROPOSE_WRITE, HOST_STORAGE_SET,
};
